...
class StocksTest < ApplicationSystemTestCase
  ...
  test "creating a Stock" do
    ...
    fill_in "Ammount", with: @stock.ammount
    fill_in "Close price", with: @stock.close_price
    fill_in "High", with: @stock.high
    fill_in "Low", with: @stock.low
    fill_in "Name", with: @stock.name
    fill_in "Open price", with: @stock.open_price
